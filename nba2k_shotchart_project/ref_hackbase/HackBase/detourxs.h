...
LPVOID DetourCreate(LPVOID lpFuncOrig, LPVOID lpFuncDetour, DETOUR_TYPE patchType, int detourLen=DETOUR_LEN_AUTO);
LPVOID DetourCreate(LPCSTR lpModuleName, LPCSTR lpProcName, LPVOID lpFuncDetour, DETOUR_TYPE patchType, int detourLen=DETOUR_LEN_AUTO);
