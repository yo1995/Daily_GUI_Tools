...
{
	return DetourCreate(lpFuncOrig, lpFuncDetour, DETOUR_TYPE_JMP, detourLen);
}

// Thin wrapper for APIs
LPVOID DetourCreate(LPCSTR lpModuleName, LPCSTR lpProcName, LPVOID lpFuncDetour, DETOUR_TYPE patchType, int detourLen)
{
	...
	return DetourCreate((LPVOID)CheckPointer((DWORD)lpFuncOrig), lpFuncDetour, patchType, detourLen);
}

LPVOID DetourCreate(LPVOID lpFuncOrig, LPVOID lpFuncDetour, DETOUR_TYPE patchType, int detourLen)
{
